...
<div id="peopleChart" style="width: 100%;height:1000px; margin-right: auto;"></div>
...
<div id="moneyComparisonChart" style="width: 100%;height:1000px; margin-right: auto;"></div>

### 2023，2024年jz pk人数比较

<div id="peopleComparisonChart" style="width: 100%;height:1000px; margin-right: auto;"></div>
...
Highcharts.chart('totalChart', {
    ...
    xAxis: {
        categories: ['4.14', '5.02-5.03', '5.18-5.19', '6.01-6.02'],
        crosshair: true
    },
    yAxis: [{
        labels: {
    ...
    series: [{
        name: '非flag金额',
        data: [25882.7, 30250.2, 16187.9, 16761.53],
        tooltip: {
            valueSuffix: '元'
        }
    }, {
        name: 'flag金额',
        data: [6500, 24711.5, 7200, 7400],
        tooltip: {
            valueSuffix: '元'
        }
    }, {
        ...
        type: 'line',
        yAxis: 1,
        data: [32382.7, 54961.7, 23387.9, 24661.53],
        tooltip: {
            valueSuffix: '元'
        }
    }]
...
Highcharts.chart('portionChart', {
  ...
  xAxis: {
    categories:[
        '4.14', '5.02-5.03', '5.18-5.19', '6.01-6.02'
    ]
...
Highcharts.chart('moneyComparisonChart', {
    ...
    series: [{
        name: '2023年jz金额',
        data: [22237.90, 15616.80, 45405.90, 20819.00]
    }, {
        name: '2024年jz金额',
        data: [32382.7, 54961.7, 23387.9, 24611.53]
    }],
