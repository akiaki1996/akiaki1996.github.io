...
Highcharts.chart('totalChart', {
    ...
    xAxis: {
        categories: ['4.14', '5.02-5.03', '5.18-5.19', '6.01-6.02', '6.08-6.10', '6.15-6.16', '6.22', '6.28-7.2'],
        crosshair: true
    },
    yAxis: [{
        labels: {
    ...
    series: [{
        name: '非flag金额',
        data: [25882.7, 30250.2, 16187.9, 16761.53, 35328.6, 13121.8, 10392.3, 65043.7],
        tooltip: {
            valueSuffix: '元'
        }
    }, {
        name: 'flag金额',
        data: [6500, 24711.5, 7200, 7400, 11343, 6970, 5970, 5446],
        tooltip: {
            valueSuffix: '元'
        }
    }, {
        ...
        type: 'line',
        yAxis: 1,
        data: [32382.7, 54961.7, 23387.9, 24661.53, 46671.6,20091.8, 16362.3, 70489.7],
        tooltip: {
            valueSuffix: '元'
        }
    }]
...
Highcharts.chart('portionChart', {
  ...
  xAxis: {
    categories:[
        '4.14', '5.02-5.03', '5.18-5.19', '6.01-6.02', '6.08-6.10', '6.15-6.16', '6.22', '6.28-7.2'
    ]
  ...
  series: [{
    name: 'flag总额比',
    data: [0.2, 0.449, 0.307, 0.32, 0.24, 0.34, 0.36, 0.077]
  }],
...
Highcharts.chart('peopleChart', {
  ...
  series: [{
    name: '人',
    data: [189, 232, 164, 153, 206, 161, 148, 178]
  }],
...
Highcharts.chart('moneyComparisonChart', {
    ...
    series: [{
        ...
        data:
            [32382.7, 54961.7, 23387.9, 24611.53, 46671.6, 20091.8, 16362.3, 70489.7]
    }, {
        name: '2023',
        data:
            [22237.90, 15616.80, 45405.90, 20819.00, 45532.9, 84922.5, 36903.24, 62226.1]
    }]
});
...
Highcharts.chart('peopleComparisonChart', {
    ...
    series: [{
        ...
        data:
            [119, 114, 176, 172, 208, 284, 230, 316],
    }, {
        name: '2024',
        data:
            [189, 232, 164, 153, 206, 161, 148, 178]
    }]
});
...
Highcharts.chart('myChart', {
    ...
    series: [
        {
            name: '元',
            data: [20, 1060, 20, 510, 983, 1000, 1000, 183.52]
        },
