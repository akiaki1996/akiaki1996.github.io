...
2024年截止到今日pk金额:  370931.98
2023同期pk金额: 422957.54
2024截止到今日我的pk花销: 7353.75
...
Highcharts.chart('totalChart', {
    ...
    series: [{
        name: '非flag金额',
        data: [25882.7, 30250.2, 16187.9, 16761.53, 35328.6, 13121.8, 10392.3, 65043.7, 10869.78, 51029.97],
        tooltip: {
            valueSuffix: '元'
        }
    }, {
        name: 'flag金额',
        data: [6500, 24711.5, 7200, 7400, 11343, 6970, 5970, 5446, 5023, 15500],
        tooltip: {
            valueSuffix: '元'
        }
    }, {
        ...
        type: 'line',
        yAxis: 1,
        data: [32382.7, 54961.7, 23387.9, 24661.53, 46671.6,20091.8, 16362.3, 70489.7, 15892.78, 66529.97],
        tooltip: {
            valueSuffix: '元'
        }
    }]
...
Highcharts.chart('portionChart', {
  ...
  xAxis: {
    categories:[
        '4.14', '5.02-5.03', '5.18-5.19', '6.01-6.02', '6.08-6.10', '6.15-6.16', '6.22', '6.28-7.2', '7.6', '7.12-7.13'
    ]
  ...
  series: [{
    name: 'flag总额比',
    data: [0.2, 0.449, 0.307, 0.32, 0.24, 0.34, 0.36, 0.077, 0.316, 0.233]
  }],
...
Highcharts.chart('peopleChart', {
  ...
  series: [{
    name: '人',
    data: [189, 232, 164, 153, 206, 161, 148, 178, 106, 221]
  }],
...
Highcharts.chart('moneyComparisonChart', {
    ...
    series: [{
        name: '2024',
        xData: ['2024-04-01', '2024-05-02', '2024-05-18', '2024-06-01', '2024-06-08', '2024-06-22', '2024-06-28', '2024-07-06', '2024-7-13'],
        data:
            [32382.7, 54961.7, 23387.9, 24611.53, 46671.6, 20091.8, 16362.3, 70489.7, 15892.78, 65529.97]
    }, {
        name: '2023',
        data:
            [22237.90, 15616.80, 45405.90, 20819.00, 45532.9, 84922.5, 36903.24, 62226.1, 41198.4, 48094.8]
    }]
});
...
Highcharts.chart('peopleComparisonChart', {
    ...
    series: [{
        ...
        data:
            [119, 114, 176, 172, 208, 284, 230, 316, 258, 190],
    }, {
        name: '2024',
        data:
            [189, 232, 164, 153, 206, 161, 148, 178, 106, 221]
    }]
});
...
Highcharts.chart('myChart', {
    ...
    series: [
        {
            name: '元',
            data: [20, 1060, 20, 510, 983, 1000, 1000, 183.52, 567.23, 2010]
        },
